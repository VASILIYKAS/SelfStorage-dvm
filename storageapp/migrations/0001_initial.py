    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(help_text='Номер телефона клиента', max_length=128, region=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ManyToManyField(related_name='storages', to=settings.AUTH_USER_MODEL, verbose_name='Пользователи')),
            ],
        ),
    ]
