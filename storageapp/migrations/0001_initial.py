    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='boxes_in_order', to='storageapp.box', verbose_name='Арендованный бокс')),
                ('discounts', models.ManyToManyField(blank=True, related_name='discounted_orders', to='storageapp.discount', verbose_name='Промокоды')),
